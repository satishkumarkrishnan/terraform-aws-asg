...
export efs_hostname=fs-0f4a48edafa2ea421.efs.ap-northeast-1.amazonaws.com
systemctl enable --now nfs-server
# Actually mount the EFS filesystem
sudo mount -t nfs4 -o nfsvers=4.1,rsize=1048576,wsize=1048576,soft,timeo=600,retrans=2,noresvport "${efs_hostname}:/" /tmp/efs
# Mounting Efs 
